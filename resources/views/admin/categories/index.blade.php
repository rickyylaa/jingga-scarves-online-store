...
<div class="pc-container">
    <div class="pc-content">
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        <h5>Kategori</h5>
                        <button type="button" class="btn btn-icon btn-primary rounded bg-primary" data-bs-toggle="modal" data-bs-target=".addnewcategory">
                                                ...
                                                <td>
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            ...
                                                            @csrf
                                                                @method('DELETE')
                                                                <a href="{{ route('category.edit', $row->id) }}" class="dropdown-item"><i class="bx bx-edit-alt me-1"></i>Edit</a>
        ...
        <div class="modal fade addnewcategory" tabindex="-1" role="dialog" aria-labelledby="addNewCategoryLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title h4" id="addNewCategoryLabel">Tambah Kategori</h5>
